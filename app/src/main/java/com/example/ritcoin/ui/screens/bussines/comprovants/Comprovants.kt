package com.example.ritcoin.ui.screens.comprovants
    ...
    FlexColumn() {
        inflexible {
            TopAppBar(
                ...
                title = { Text(text = "Pagina de Comprovantes", style = +themeTextStyle { subtitle2 }) }
            )
        }
        expanded(1f){
            Text(text = "Lista de Comprovantes Aqui")
        }
    }
}